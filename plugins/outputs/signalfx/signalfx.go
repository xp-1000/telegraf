...
func (s *SignalFx) Connect() error {
	...
	if s.IngestURL != "" {
		client.DatapointEndpoint = realm.DatapointEndpointForIngestURL(s.IngestURL)
		client.EventEndpoint = realm.EventEndpointForIngestURL(s.IngestURL)
	} else if s.SignalFxRealm != "" {
		client.DatapointEndpoint = realm.DatapointEndpointForRealm(s.SignalFxRealm)
		client.EventEndpoint = realm.EventEndpointForRealm(s.SignalFxRealm)
	} else {
